...
- 🌱 I’m currently learning HTML, CSS, JavaScript with the Rocketseat team in the 2nd En of the NextLevelWeek (NLW) event, on the Discovery Trail. There I'm creating a educational website, and it's been a amazing time and I'm learning so much. I'm also learning Python on my own.
...
- 🌱 Atualmente, estou aprendendo HTML, CSS e JavaScript com a equipe Rocketseat na 2ªEd do evento NextLevelWeek (NLW), na Trilha Discovery. Lá, estou criando um site educacional, e tem sido um momento incrível e estou aprendendo muito. Também estou aprendendo Python sozinha.
